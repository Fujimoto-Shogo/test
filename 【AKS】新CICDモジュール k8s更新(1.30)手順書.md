...
* 更新後確認(1.27→1.30)
  * k8s version更新確認  
    ...
    ```
    az aks nodepool get-upgrades --resource-group aks-test20240610-resources-group --cluster-name aks-test20240610 --nodepool-name runtime --output table
The behavior of this command has been altered by the following extension: aks-preview
    ```
    ```
    az aks nodepool get-upgrades --resource-group aks-test20240610-resources-group --cluster-name aks-test20240610 --nodepool-name data --output table
The behavior of this command has been altered by the following extension: aks-preview
    ```
